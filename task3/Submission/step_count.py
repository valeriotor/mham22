...
def step_count(x_axis, net_magnitude, factor1, factor2):
    ...
    for walk in walk_list:
        ...
        for i, step in enumerate(walk):
            ...
            en1 = energies[ts]
            en2 = energies[ts-0.5]
            if (en1 > avg*factor1 or (ts > 0 and en2 > avg*factor1) or (i == 0 and energies[ts+0.5] > avg*factor1)) and (en1 < avg*factor2 or (ts > 0 and en2 < avg*factor2)): 
